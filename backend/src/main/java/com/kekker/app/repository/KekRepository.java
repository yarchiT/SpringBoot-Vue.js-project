...
public interface KekRepository extends JpaRepository<Kek, Long>{
   ...
   @Query("select new map(k.text as text, k.image as img, k.createDate as date, c as comments, r as reacts) from Kek k left join k.comments c left join k.reactions r where k.owner.nickName=?1")
